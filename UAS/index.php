                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="detail-box">
                            ...
                            <p>
                                Selamat datang di layanan perbaikan dan perawatan kami yang profesional.
                            </p>
                    ...
                    <div class="col-md-6">
                        <div class="img-box mb-5">
                            <img src="images/bg1.png" alt="Background Image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="feature_container">
                ...
                <div class="box">
                    ...
                    <a href="./Kost/kost.php" class="name" >
                        <h5>Sewa Kost</h5>
                    </a>
                </div>
                <div class="box">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6">
                    <div class="detail-box">
                        ...
                        <p>
                            Selamat datang di Sewa Kost, penyedia layanan sewa kost yang mengutamakan kenyamanan dan keamanan. Kami menyediakan berbagai pilihan kost yang terjangkau dan berkualitas untuk memenuhi kebutuhan hunian Anda. Dengan komitmen kami untuk menyediakan lingkungan yang ramah dan layanan yang prima, kami siap membantu Anda menemukan rumah sementara yang sempurna.
                        </p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6">
                    <div class="img-box">
                        <img src="images/about-img.jpg" alt="Gambar Tentang Kami">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box">
                        <div class="img-box">
                            <img src="images/s1.png" alt="Icon Maintenance">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Perawatan Rutin
                            ...
                            <p>
                                Kami menyediakan layanan perawatan rutin untuk memastikan kost Anda selalu dalam kondisi terbaik.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box">
                        <div class="img-box">
                            <img src="images/s2.png" alt="Icon Electrical">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Pekerjaan Listrik
                            ...
                            <p>
                                Kami memiliki teknisi ahli untuk menangani perbaikan dan instalasi listrik di tempat tinggal Anda.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box">
                        <div class="img-box">
                            <img src="images/s3.png" alt="Icon Plumbing">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Pekerjaan Pipa
                            ...
                            <p>
                                Layanan perbaikan dan perawatan sistem pipa agar air mengalir dengan lancar di tempat Anda.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="info_items">
                        <div class="row">
                            <div class="col-md-4">
                                <a target="_blank" href="https://www.google.com/maps/dir/-7.7551252,110.4218972/Jl.+Paingan,+Krodan,+Maguwoharjo,+Kec.+Depok,+Kabupaten+Sleman,+Daerah+Istimewa+Yogyakarta+55281/@-7.752419,110.4189081,16.5z/data=!4m8!4m7!1m0!1m5!1m1!1s0x2e7a5981b0800467:0xca79cc92129cbebc!2m2!1d110.4213403!2d-7.755131?entry=ttu">
                                    <div class="item">
                                        <div class="img-box">
                            ...
                            <div class="col-md-4">
                                <a href="mailto:sewakostkeren@gmail.com">
                                    <div class="item">
                                        <div class="img-box">
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                        </div>
                                        <p>
                                            sewakostkeren@gmail.com
                                        </p>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer_content text-center">
                        <p>&copy; 2024 Sewa Kost. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
